...
public class GenericObjectTest {
    public static class GenericObject<T> implements Storable {
        /**
         *
         */
    ...
    public static void main(final String[] args) {
        ...
        final String string = "{\"field\":1}";
        JSonStorage.setMapper(new JacksonMapper());
        final GenericObject<Integer> jackons = JSonStorage.restoreFromString(string, new TypeRef<GenericObject<Integer>>() {
        });
        JSonStorage.setMapper(new SimpleMapper());
        final GenericObject<Integer> simple = JSonStorage.restoreFromString(string, new TypeRef<GenericObject<Integer>>() {
        });
