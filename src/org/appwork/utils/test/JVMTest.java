...
public class JVMTest {
    public static void main(String[] args) {
        ...
        System.out.println(JVMVersion.parseJavaVersionString("11.0.2") == 11000002000000l);
        System.out.println(JVMVersion.parseJavaVersionString("11.0.2") > JVMVersion.JAVA19);
        System.out.println(JVMVersion.parseJavaVersionString("12+33") == 12000000000033l);
        System.out.println(JVMVersion.parseJavaVersionString("13-ea+25") == 13000000000025l);
    }
}
