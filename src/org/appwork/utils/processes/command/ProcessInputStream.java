...
public class ProcessInputStream extends InputStream {
    ...
    public ProcessInputStream(final Process process, final InputStream is) {
        this.process = process;
        this.is = is;
        if (is != process.getInputStream() && is != process.getErrorStream()) {
            throw new IllegalArgumentException("Inputstream must be either Process.getInputStream or Process.getErrorStream");
        }
        new Thread() {
            {
                setDaemon(true);
